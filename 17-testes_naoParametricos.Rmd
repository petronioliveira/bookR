...
Assim como no cálculo manual, o teste com a função do `rstatix`, mostra uma diferença estatisticamente significativa (*P* = `r teste$p`) entre os tempos de hospitalização dos recém-nascidos que realizaram cirurgia no período neonatal que se infectaram ou não (diferença mediana = 14 dias; IC95% : 5,0 – 19,5).

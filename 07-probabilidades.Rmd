...
A definição frequentista também pode ser aplicada no cotidiano. Utilizando a altura de 1368 mulheres, uma medida numérica contínua, embutida no conjunto de dados `dadosMater.xlsx` (veja Seção \@ref(sec-mater)). Essas alturas serão selecionadas e colocadas em um objeto, denominado `dados`.
